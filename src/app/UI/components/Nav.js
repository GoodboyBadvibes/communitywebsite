    ...
    <>
      <div className={` flex items-center justify-between genPad ${style.nav}`}>
        ...
        <div className={ `flex items-center justify-between gap-10 ${style.navLinks} `}> 
          ...
          <p>ABOUT US</p>
          <div className=' flex items-start'><p>PORTALS  </p><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="size-6">
